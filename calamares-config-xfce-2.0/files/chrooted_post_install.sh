...
## Copyright (C) 2025-2029 Munna_SK <arafsos@protonmail.com>
##
## Post installation script for Araflinux (Executes on target system to perform various operations)
...
_perform_various_stuff() {
	...
	cp -rf /usr/share/grub/themes/araflinux /boot/grub/themes
    ...
    [[ -x `which araflinux-hooks-runner` ]] && araflinux-hooks-runner
